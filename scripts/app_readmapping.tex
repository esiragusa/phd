...
BWA-SW is designed to map Roche/454 reads, which have an average length of 400~bp.
...
Soap~3 is algorithmically similar to Soap~2 but targets only NVIDIA CUDA accelerators.
...
The GEM mapper is a flexible read aligner for Illumina/Solexa, AB/SOLiD, and Ion Torrent reads.
