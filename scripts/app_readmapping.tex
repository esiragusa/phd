...
Conversely, most prominent all-mappers are based on filtering algorithms for approximate string matching.
...
The lack of any proper pair of mapping locations signals a potential structural variation, \eg a long indel or an inversions.
