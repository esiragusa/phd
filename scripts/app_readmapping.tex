...
\begin{table}[h]
\begin{center}
\caption[Mappability]{Mappability of model genomes.}
...
\begin{table}[h]
\begin{center}
\caption[Genome mappability score]{Human genome mappability score of various sequencing technologies.}
...
% showing that it represents the state of the art in terms of speed and sensitivity.
