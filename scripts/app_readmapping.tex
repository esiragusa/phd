...
High-throughput sequencing (HTS) is a fundamental technology.
...
Read mapping is a critical step in all HTS data analysis pipelines.
...
First I present sequencing technologies from the standpoint of the bioinformatician who has to perform secondary analysis of the data.
Then I discuss what makes secondary analysis hard.
Finally I divide reference-mapping secondary analysis methods in two paradigms: best-mapping and all-mapping.
I present popular read mapping tools.
