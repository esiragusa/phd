...
Variant calling algorithms in all-mapping have the potential to detect a wider spectrum of genomic variation events than in best-mapping.
For instance, variant callers based on the all-mapping paradigm detect CNVs \citep{mrCaNaVaR}, and SNVs in homologous regions \citep{Sniper}.
...
What is the limit of secondary analysis pipelines?
What bias is produced by repetitive elements?
