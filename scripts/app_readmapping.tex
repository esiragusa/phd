...
In order to evaluate Masai, we designed three experiments: \begin{inparaenum}[(i)]
\item Rabema,
...
As expected, RazerS\,3 shows full-sensitivity and mrFAST loose only a minimal percentage of mapping locations.
