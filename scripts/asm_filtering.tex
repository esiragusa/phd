...
As edit distance verification algorithm, I use a banded version of the Myers' algorithm \citep{Myers1999}.
...
%Instead of the specificity, I measured the positive predictive value (PPV).
