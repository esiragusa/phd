...
Gapped $q$-grams are based on a generalization of the $q$-gram similarity measure (section~\ref{sec:filtering:qgrams-ext}) to \emph{subsequences}.
A subsequence is a non-contiguous sequence of symbols of a given string.
Hence, instead of substrings, the $Q$-gram measure counts the number of common subsequences of length $q$, whose symbols are taken from a fixed set $Q$ of positions.
