...
I denote the Hamming distance of the transcript by $|\sigma|_0=m - \sum \sigma$.
Accordingly, I denote by $\Bo^m_k \subset \Bo^m$ the set containing all transcripts $\sigma$ \st $|\sigma|_0 = k$.
...
\citeauthor{Burkhardt2001} give a DP algorithm computing the optimal threshold in time $\Oh(m \cdot k \cdot 2^{s(Q)})$ \citep{Burkhardt2001}.
