...
I start by modeling the decision problem \textsc{Non Detection} before turning to the optimization problem \textsc{Optimal Threshold}.
...
\begin{minipage}[t]{.8\textwidth}
\begin{algorithm}[H]
\Algorithm{TranscriptsCount}{$Q,t,m$}
\begin{tabular}{ll}
\textbf{Input}  & $Q$ : $Q$-gram sequence\\
