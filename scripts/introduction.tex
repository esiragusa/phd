...
In this work, I present efficient methods for the mapping of high-throughput sequencing reads, based on state of the art approximate string matching algorithms and data structures.
Read mapping is an ubiquitous and non-trivial task in all resequencing applications.
As actual HTS instruments attain a throughput of 5~Gbp/h.
Efficient read mapping methods are still needed.

%Presented read mapping methods work at least for reads coming from WGS, WES, and ChIP-seq protocols.


Part I is about approximate string matching, part II about read mapping.
The initial ingenuity turns out to be beneficial in the design of an accurate method for read mapping.
