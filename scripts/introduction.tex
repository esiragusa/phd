...
This protocol consists in the targeted sequencing of the \emph{exome}, \ie the subset of the human genome that is protein coding.
%WES allows dissecting the genetic basis of diseases and traits that have proved to be intractable to conventional gene-discovery strategies.
...
RNA-seq provides a myriad of information on gene expression, alternative splicing, intron/exon boundaries, untranslated regions (UTRs), and genetic variation, all with single-base accuracy.
