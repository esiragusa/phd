...
In addition, I introduce a formal framework for (multiple) gapped $q$-grams, which leads to the formulation of APX and FPRAS\footnote{Randomized Polynomial-Time Approximation Scheme} algorithms  answering some combinatorially hard filter design questions.
