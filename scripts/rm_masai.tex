...
It was straightforward to reuse SeqAn's suffix trie implementations, presented in chapter \ref{chr:index}, to emulate tries.
...
Table~\ref{tab:Rabema} shows the results on \emph{H.~sapiens}.
...
I remark that Masai is not full-sensitive whenever approximate seeds are used, \eg on \emph{H.~sapiens}. Indeed, Masai loses 0.1\,\% overall sensitivity in respect to RazerS\,3.
...
Results for \emph{C.~elegans} and \emph{H.~sapiens} are shown in table~\ref{tab:Runtime}.
