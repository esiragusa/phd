...
The construction of the ESA of the \emph{H.~sapiens} reference genome (hg19) takes about 1.5~hours and the index consumes 39~GB of memory.% (see table~\ref{tab:index:construction}).
...
Starting from the implementation of \citep{Singer2013}, I realized a generalized FM-index based on a wavelet tree~\citep{Grossi2003}.
