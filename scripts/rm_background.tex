...
In this chapter, I provide the reader with background knowledge in the fast-moving field of high-throughput sequencing (HTS) read mapping.
...
Afterwards, in section \ref{sec:paradigms}, I present two popular paradigms for reference-guided assembly: best-mapping and all-mapping.
In section \ref{sec:mappability}, I review two studies on the hardness of HTS data analysis.
...
Since base callers output base call probabilities in Phred-scale along with the reads, \cite{Li2008} propose a novel probabilistic scoring scheme called \emph{mapping quality}, encoding the probability that a read aligns correctly at a mapping location in the reference genome.
...
Some objections can be raised against this definition of mapping quality scores.
...
Third, this definition of mapping quality tends to become less relevant as base calls improve, due to advances of sequencing technologies, and thus degenerates into a shallow measure of uniqueness.
...
Finally, Masai \citep{Siragusa2013} and Yara \citep{Siragusa2014} are read mapping programs developed by myself.
