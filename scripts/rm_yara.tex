...
Subsequently, the benchmark \epmh{stratifies} (\ie sorts) mapped reads by mapping quality, \st reads that each tool estimates to be correctly mapped precede those which are estimated to be incorrectly mapped.
