...
\begin{figure}[t]
\begin{center}
\caption[Yara accuracy results on Illumina-like single-end reads]{Accuracy results on $100\,\text{bp}$ Illumina-like single-end reads.}
...
\begin{table}[b]
\begin{center}
\caption[Yara throughput results on Illumina-like single-end reads]{Throughput results on $100\,\text{bp}$ Illumina-like single-end reads.}
\sffamily
...
\begin{figure}[t]
\begin{center}
\caption[Yara accuracy results on Illumina-like paired-end reads]{Accuracy results on $2 \times 100\,\text{bp}$ Illumina-like paired-end reads.}
...
\begin{table}[b]
\begin{center}
\caption[Yara throughput results on Illumina-like paired-end reads]{Throughput results on $2 \times 100\,\text{bp}$ Illumina-like paired-end reads.}
\sffamily
...
\begin{figure}[t]
\begin{center}
\caption[Yara SNVs calling accuracy results]{SNVs calling accuracy results on a $150\, \times$ coverage WES run consisting of $2 \times 100\,\text{bp}$ Illumina HiSeq 2000 reads (SRA/ENA id: SRR1611178).}
...
\begin{figure}[t]
\begin{center}
\caption[Yara INDELs calling accuracy results]{INDELs calling accuracy results on a $150\, \times$ coverage WES run consisting of $2 \times 100\,\text{bp}$ Illumina HiSeq 2000 reads (SRA/ENA id: SRR1611178).}
