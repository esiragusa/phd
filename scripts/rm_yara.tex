...
\begin{table*}[t]
  ...
  \label{tab:yara:rabema}
    ...
    The left panel shows the results of best-mapping $10\,\text{M}$ whole human genome $100\,\text{bp}$ Illumina HiSeq 2000 reads; the right panel shows the results of all-mapping only the first $1\,\text{M}$ reads.
