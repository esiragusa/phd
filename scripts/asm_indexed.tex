...
As text, I take the C.~elegans reference genome (WormBase WS195), \ie a collection of 6 DNA strings of about 100~MB total length.
...
Recently, various popular bioinformatics tools \citep{Langmead2009, Li2009} adopted variations of this method in conjunction with an FM-index.
