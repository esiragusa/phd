...
\begin{figure}[h]
\begin{center}
\caption[Example of binary rank dictionaries]{Binary rank dictionaries (RDs) of the string $s=$ {\ttfamily 010101100100}. (\subref{fig:rd1}) One-level RD with $b=4$; for instance, $\rank_1(s, 6) = R[2] + \rank_1(s_{5 \dots 6}, 2) = 3$. (\subref{fig:rd2}) Two-levels RD with $b=2$; for instance, $\rank_1(s, 6) = R^2[2] + R[3] + \rank_1(s_{5 \dots 6}, 1) = 3$.}
...
\ttfamily
\begin{tabular}{rcccc}
$i$	& $s_{\frac{i}{2}}$	& $s_i$ & $R_{\sigma}[\frac{i}{b}][\rho(c)]$ & $c$\\
\midrule
1   & C & 0 & 0 & A\\
2   &   & 1 & 0 & C\\
3   & T & 1 & 0 & G\\
