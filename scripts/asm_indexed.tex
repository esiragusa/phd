...
Answering this query requires counting the number of occurrences of the character $\StrieChar$ inside a block of $b$ bite.
...
The matrix $R_{\sigma}$ has thus $\sigma$ rows and $\Oh(\xfloor{\Slen \log{\sigma}/\log{\Slen}})$ columns, each one consuming $\xceil{\log{\Slen}}$ bits.
