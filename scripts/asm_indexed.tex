...
\begin{definition}
The \emph{suffix array} of a padded string $s$ of length $n$ is an array $A$ containing a permutation of the interval $[1,n]$, \st $\String{A[i] \dots n} <_{lex} \String{A[i+1] \dots n}$ for all $1 \leq i < n$.
\end{definition}
