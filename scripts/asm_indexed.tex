...
\begin{figure}[h]
\begin{center}
\caption[Example of wavelet tree]{Example of wavelet tree of the DNA string $s=$ {\ttfamily CTCGCA}. The alphabet $\Sigma_{\text{DNA}}$ is decomposed as $\{ \{A,C\}, \{G,T\} \}$. In the example, $\rank_C(s,4) = \rank_1(b^{AC}, \rank_0(b,4))$.}
\label{fig:wt_dna}
\ttfamily
