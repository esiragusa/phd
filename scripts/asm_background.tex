...
Note that the suffix trie so defined contains $\Oh(n^2)$ nodes, yet I only consider the suffix trie as an idealized data structure to expose our algorithms.
