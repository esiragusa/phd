...
I denote with $\Substring{\String}{i}{j}$ the sequence of symbols $\Subscript{\String}{i} \ldots \Subscript{\String}{\AtEnd{j}}$ (excluding $j$) for any $\At{1} \leq i \leq j \leq \Slen$, where $\Slen=|\String|$ is the length of $\String$.
