...
In this manuscript, I often consider \emph{multiple} string matching problems.
Multiple variants of the problems provide many patterns at once.
Clearly any algorithm for the single variant can solve the multiple one and vice versa.
However multiple methods can be more efficient.
