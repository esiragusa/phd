...
\end{definition}
The \emph{lexicographical order} $<_{lex}$ between two non-empty strings $\XSeq,\YSeq$ is defined as $\XSeq <_{lex} \YSeq \iff \Subscript{\XSeq}{\At{1}} < \Subscript{\YSeq}{\At{1}}, \text{ or } \Subscript{\XSeq}{\At{1}} = \Subscript{\YSeq}{\At{1}} \text{ and } \Suffix{\XSeq}{\At{2}} <_{lex} \Suffix{\YSeq}{\At{2}}$.
...
An \emph{array} (or table, or vector) $V=\Subscript{V}{\At{1}} \Subscript{V}{\At{2}} \dots \Subscript{V}{\AtEnd{\Slen}}$ is a finite sequence of numbers $\Subscript{V}{i} \in \N_0$ (or any subset of $\N_0$).
