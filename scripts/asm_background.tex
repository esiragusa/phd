...
A \emph{string} (or word) $\String=s_1 s_2 \dots s_n$ over an alphabet $\Sigma$ is a finite sequence of symbols $s_i \in \Sigma$.
I denote by $\Substring{\String}{i}{j}$ the \emph{concatenated} symbols $s_i \dots s_j$, and by $|\String|=n$ the length of $\String$.
