...
For convenience, often I denote simply by $y_{i \dots}$ the suffix of $y$ beginning at position $i$.

The definition of occurrence is fundamental to introduce string matching problems.
...
I extend the above definitions of prefix, suffix and substring also to multisets, \eg $\Sc_{(d,i) \dots (d,j)}$ denotes the substring $s^d_{i \dots j}$.
