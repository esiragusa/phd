...
Let us consider the alphabet consisting of DNA bases: $\Sigma = \{A,C,G,T\}$.
...
An alignment is a way of visualizing an edit transcript between two strings.

TODO: add an example of edit transcript, edit and hamming distance, alignment.

\subsubsection{Problems}

We can now define exact string matching, the most fundamental problem in stringology.
