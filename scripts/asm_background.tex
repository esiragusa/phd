...
Filtering methods apply combinatorial criteria to determine which portions of the text must be filtered in as they might contain some occurrence of the pattern.
